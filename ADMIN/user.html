    ...
    <div class="col" id="body-col">
      ...
      <div class="form-row">
        <div class="col-md-2 mb-3 mr-auto">
          ...
          <input type="text" class="form-control"  id="validationTooltip01" placeholder="Produk id" required>
        </div>
        <div class="col-md-2 mb-3 mr-auto">
          <label for="validationTooltip01">Kategori id</label>
          <input type="text" class="form-control"  id="validationTooltip02" placeholder="Kategori id" required>
        </div>
        <div class="col-md-2 mb-3 mr-auto">
          <label for="validationTooltip01">Nama Produk</label>
          <input type="text" class="form-control"  id="validationTooltip03" placeholder="Nama Produk" required>
        </div>
        <div class="col-md-2 mb-3 mr-auto">
          <label for="validationTooltip02">Harga Produk</label>
          <input type="text" class="form-control"  id="validationTooltip04" placeholder="Harga Produk" required>
        </div>
        <div class="col-md-2 mb-3 mr-auto">
          <label for="validationTooltip02">Warna Produk</label>
          <input type="text" class="form-control"  id="validationTooltip04" placeholder="Warna Produk" required>
        </div>
      </div>
    </div>
  </div>
