      ...
      <table class="table">
        ...
        <thead>
          ...
          <tr>
            ...
            <th>Rp. 50.000</th>
            <th>blue</th>
            <th><button class="btn" style="background-color: white;"><i class="bi bi-trash"></i></button></th>
          </tr>
        </thead>
      </table>
    </div>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function () {
        $('.addproductbtn').on('click',function(event){
            var str1 = $(".ID").val();
            var str2 = $(".kategori_id").val();
            var str3 = $(".nama_produk").val();
            var str4 = $(".harga_produk").val();
            var str5 = $(".warna_produk").val();
            console.log(str1);
            console.log(str2);
            console.log(str3);
            console.log(str4);
