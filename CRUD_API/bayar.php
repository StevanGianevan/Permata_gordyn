                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="cart.html">
                            <span><i class="fa fa-shopping-bag non-empty"></i></span>
                    ...
                    <div class="card-body">
                        <div class="row align-content-center justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <ul>
                                    <li>
                                        <p style="font-weight: 600; text-transform: uppercase;">Bristol</p>
                                    </li>
                                    <li>
                                        <p>ukuran : 2 m x 3 m</p>
                                    </li>
                                    <li>
                                        <p>warna : biru</p>
                                    </li>
                        ...
                        <p>pesanan akan di proses dalam jangka waktu 2x24 jam.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="row align-content-center justify-content-center">
                            ...
                            <div class="col-lg-8">
                                <ul>
                                    <li>
                                        No. Rekening : 1238180457
                                    </li>
                                    <li>
                                        Nama Rekening : Permata Gordyn
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="pembelian">
                            ...
                            <hr>
                            <p class="text-right"><strong> Total Harga :</strong> Rp. 150.000</p>
                        </div>
                    </div>
