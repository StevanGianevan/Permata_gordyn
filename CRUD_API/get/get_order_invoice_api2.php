...
try {
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        if(!empty($data->user_name) && !empty($data->order_status)){
            ...
            JOIN users on invoices.user_id = users.id WHERE users.name LIKE '%$user_name%' AND invoices.status = '$order_status'";
